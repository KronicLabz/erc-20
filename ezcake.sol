...
contract EzCake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    bool public CAKEDividendTokenDividendEnabled = true;
    // this lets owner add LP while trading is stopped. One time function
    bool public lockTilStart = true;
    bool public lockUsed = false;
 
    CAKEDividendTokenDividendEnabledividendTracker public CAKEDividendTracker;
 
    address public marketingWallet = 0x0acdDb50af0Db27cD34187bB90194093547c254e;
    
    uint256 public maxWalletBalance = 2 * 10**9 * 10**18;
    uint256 public swapTokensAtAmount = 500 * 10**6 * 10**9;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 bnbAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: bnbAmount}(
            address(this),
            tokenAmount,
            4100000, // slippage is unavoidable
            4100000, // slippage is unavoidable
            marketingWallet,
            block.timestamp
        );
